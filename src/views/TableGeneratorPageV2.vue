...
async function generate() {
    const indexCode = generateIndexV2(single.formTitle, single.storeName, single.columns, single.fields);
    const componentTable = generateTableTableV2(single.formTitle, single.storeName, single.columns, single.fields);
    const componentForm = generateTableFormV2(single.formTitle, single.storeName, single.columns, single.fields);
    ...
    generatedFiles.value = [
        ...
        { filename: `_components/Table.vue`, language: "html", content: componentTable },
        { filename: `_components/ModalForm.vue`, language: "html", content: componentForm },
