<template>
  <div class="min-h-screen flex flex-col md:flex-row">
      ...
      <div>
        ...
        <div class="mb-6">
          ...
          <div
            ...
            :key="i"
            class="border rounded-lg p-3 mb-3 bg-gray-50"
          >
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              />
              <input
                v-model="field.validationMessage"
                placeholder="Pesan Validasi"
                class="border p-2 rounded text-sm"
              />
              <input
                v-model="field.class"
                placeholder="col-md-6 mb-5"
                class="border p-2 rounded text-sm"
              />
            </div>
    ...
    <!-- KANAN -->
    <div
      class="md:w-1/2 w-full bg-[#1e1e1e] flex flex-col h-screen"
    >
      <div
      ...
      <div class="flex bg-[#252526] border-b border-gray-700 overflow-x-auto">
        <button
          v-for="(file, i) in generatedFiles"
          :key="file.filename"
          @click="activeTab = i"
          class="px-4 py-2 text-xs whitespace-nowrap transition-all duration-150"
          :class="
            activeTab === i
      ...
      <div class="flex-1 relative">
        <MonacoEditor
          v-if="generatedFiles[activeTab]"
          :key="generatedFiles[activeTab].filename"
          v-model:value="generatedFiles[activeTab].content"
          :language="generatedFiles[activeTab].language"
          theme="vs-dark"
